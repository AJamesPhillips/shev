...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'roster_shifttype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('hours', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2)),
        ...
        db.create_table(u'roster_shift', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('day', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shifts', to=orm['roster.Day'])),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shifts', to=orm['roster.Person'])),
            ('shift_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='shifts', to=orm['roster.ShiftType'])),
            ('supernumerary', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('start', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('end', self.gf('django.db.models.fields.TimeField')(null=True, blank=True)),
            ('hours', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2, blank=True)),
            ('contract', self.gf('django.db.models.fields.CharField')(default='REGU', max_length=4)),
            ('outcome', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['roster.Outcome'], null=True)),
    ...
    models = {
        ...
        u'roster.shift': {
            ...
            'outcome': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['roster.Outcome']", 'null': 'True'}),
