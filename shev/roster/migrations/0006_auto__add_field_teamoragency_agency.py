...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamOrAgency.agency'
        db.add_column(u'roster_teamoragency', 'agency',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamOrAgency.agency'
        db.delete_column(u'roster_teamoragency', 'agency')
    ...
    models = {
        ...
        u'roster.shifttype': {
            ...
            'time_of_day': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
        u'roster.teamoragency': {
            'Meta': {'object_name': 'TeamOrAgency'},
            'agency': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '40'})
        }
    }
