...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Day.note'
        db.alter_column(u'roster_day', 'note', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Day.note'
        db.alter_column(u'roster_day', 'note', self.gf('django.db.models.fields.TextField')(null=True))
